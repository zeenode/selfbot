...
- Windows:
    ...
    2. Open install.bat and afterwards launch.bat ! ( Only for windows users )
    3. Git clone the repository. You can do this by typing in your command prompt "git clone https://github.com/zeenode/selfbot" (You will need git which you can download from https://git-scm.com/download/win)
