...
- Windows
    ...
    3. Run the python file and input your token. You will need to do this everytime you start the selfbot. Alternitavely you can put your token in the *config.py* file.
- Linux/GNU
